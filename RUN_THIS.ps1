...
Write-Host "  - Updated Android SDK to 36" -ForegroundColor Green
Write-Host "  - Added Google Mobile Ads App ID" -ForegroundColor Green
...
Write-Host "=================================" -ForegroundColor Yellow
Write-Host ""
Write-Host "Use Windows instead of emulator:" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "This is FASTER than using an emulator!" -ForegroundColor Green
Write-Host ""
Write-Host "The game will open in a Windows window." -ForegroundColor Gray
Write-Host "Ads are disabled on desktop." -ForegroundColor Gray
Write-Host ""
